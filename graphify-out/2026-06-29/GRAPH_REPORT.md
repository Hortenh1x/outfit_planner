...
## Corpus Check
- 157 files · ~128,432 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1489 nodes · 2804 edges · 94 communities (65 shown, 29 thin omitted)
...
10. `IUserAccountRepository` - 26 edges
...
Cohesion: 0.07
Nodes (13): List, NpgsqlCommand, NpgsqlConnection, NpgsqlDataReader, NpgsqlDataSource, NpgsqlTransaction, Action, DateOnly (+5 more)
...
Cohesion: 0.09
Nodes (52): ApiErrorBody, buildExternalAuthUrl(), buildQuery(), createApiError(), createBodyReferencePhoto(), createGarment(), createOutfit(), deleteBodyReferencePhoto() (+44 more)

### Community 4 - "Schedule Service & Commands"
Cohesion: 0.10
Nodes (12): IClock, UpdateGarmentCommand, DateOnly, Guid, IReadOnlyList, ScheduleService, Guid, int (+4 more)
...
Cohesion: 0.07
Nodes (19): AmazonS3Client, bool, IAmazonS3, IDisposable, TimeSpan, IObjectStorage, ObjectStoragePutRequest, StoredObject (+11 more)
...
Cohesion: 0.07
Nodes (10): Dictionary, Outfit, DateOnly, DateTimeOffset, Guid, IEnumerable, IReadOnlyList, object (+2 more)
...
Cohesion: 0.13
Nodes (13): Guid, HashSet, IEnumerable, TryOnCostEstimate, TryOnCostEstimator, TryOnEstimateInput, CancellationToken, Guid (+5 more)

### Community 12 - "Outfit & Try-On Repositories"
Cohesion: 0.08
Nodes (7): Guid, IReadOnlyList, IBodyReferencePhotoRepository, IOutfitRepository, ITryOnJobRepository, BodyReferencePhoto, TryOnJob

### Community 13 - "Auth Route Guard"
Cohesion: 0.11
Nodes (10): AuthProvider, AuthSession, RequireAuth(), authSessionQueryKey, useAuthSession(), buildReturnUrlParam(), publicAuthPaths, readSafeReturnUrl() (+2 more)

### Community 14 - "Frontend Response Types"
Cohesion: 0.13
Nodes (22): ArrayItem, BodyReferencePhoto, BodyZone, CreatedBodyReferencePhoto, CreatedGarment, CreatedOutfit, JsonResponse, LaundryStatus (+14 more)

### Community 15 - "Outfit Utilities & Naming"
Cohesion: 0.15
Nodes (9): Outfit, BodyReferenceManager(), garmentNameFromFile(), OutfitList(), creditsLabel(), modeLabel(), BuilderPage(), sameIds() (+1 more)

### Community 16 - "User Account Repository"
Cohesion: 0.08
Nodes (7): DateTimeOffset, IUserAccountRepository, IReadOnlyList, AuthEmailVerificationToken, AuthPasswordResetToken, AuthSession, OutfitItem

### Community 17 - "Wardrobe Filter Controls"
Cohesion: 0.10
Nodes (25): GarmentFilters, UpdateGarmentInput, GarmentItem, GarmentCard(), GarmentCardProps, useEagerGarmentUploads(), colorOptions, seasonOptions (+17 more)
...
Cohesion: 0.16
Nodes (4): IStoredPhotoReader, StoredPhotoFile, TimeSpan, LocalPhotoStorage
...
Cohesion: 0.12
Nodes (4): IGarmentRepository, GarmentQuery, CreateGarmentCommand, GarmentItem

### Community 24 - "Photo Upload Service"
Cohesion: 0.19
Nodes (9): long, IncomingPhoto, IPhotoStorage, ProcessedImage, StoredPhoto, HashSet, ReadOnlySpan, PhotoUploadService (+1 more)

### Community 25 - "Outfit Service"
Cohesion: 0.17
Nodes (7): OutfitQuery, UpdateOutfitCommand, Guid, IEnumerable, int, IReadOnlyList, OutfitService

### Community 26 - "Image Processor"
Cohesion: 0.29
Nodes (5): Image, int, Rgba32, ImageProcessor, Stream

### Community 27 - "Upload Queue UI"
Cohesion: 0.13
Nodes (12): UploadQueue(), UploadQueueProps, UploadQueueTextDraft, EagerGarmentUploads, QueueUpdater, UploadQueueItem, UploadQueueItemUpdates, parseTokenText() (+4 more)

### Community 28 - "App Shell & Account UI"
Cohesion: 0.14
Nodes (9): AuthUser, UserGender, AccountAvatar(), accountName(), AccountPanel(), AppShell(), ThemeMode, ThemeToggle() (+1 more)
...
Cohesion: 0.47
Nodes (3): frontendRoot, registerServiceWorker(), queryClient
...
Cohesion: 0.23
Nodes (4): StoredImageVariant, string, TimeSpan, StoredPhotoUrlRefresher
...
Cohesion: 0.20
Nodes (8): buildMonthCalendar(), CalendarGridDay, weekDayLabels, OutfitChoiceList(), CalendarPage(), dateFromIso(), EditorialDatePicker(), PanelTitle()
...
Cohesion: 0.10
Nodes (20): GarmentMetadataInput, GarmentCategory, SlotPicker(), CATEGORY_SELECTION_KEYS, GARMENT_CATEGORIES, groupGarmentsByCategory(), selectedGarmentIds(), selectionLabel() (+12 more)
...
Cohesion: 0.14
Nodes (8): IReadOnlyCollection, BodyZone, GarmentCategory, GarmentRules, HashSet, IEnumerable, IReadOnlyList, OutfitRules
...
Cohesion: 0.28
Nodes (3): DateOnly, IOutfitScheduleRepository, ScheduledOutfit

## Knowledge Gaps
- **234 isolated node(s):** `CreateBodyReferencePhotoRequest`, `CreateGarmentRequest`, `UpdateGarmentRequest`, `CreateOutfitRequest`, `UpdateOutfitRequest` (+229 more)
...
- **Why does `TryOnService` connect `Try-On Cost Estimator` to `Schedule Service & Commands`, `Try-On Background Worker`, `Outfit & Try-On Repositories`, `User Account Repository`, `Try-On Output Storage`, `HTTP Try-On Providers`, `Community 87`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `PostgresOutfitStore` connect `PostgreSQL Outfit Store` to `In-Memory Outfit Store`, `User Account Persistence`, `Outfit & Try-On Repositories`, `User Account Repository`, `External Login Persistence`, `Community 85`, `Garment Repository & Search`, `Schedule & Share Repositories`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `IUserAccountRepository` connect `User Account Repository` to `PostgreSQL Outfit Store`, `Auth Service & Security`, `File-Backed Outfit Store`, `User Account Persistence`, `In-Memory Outfit Store`, `Try-On Cost Estimator`, `Outfit & Try-On Repositories`, `External Login Persistence`?**
