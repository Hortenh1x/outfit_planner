...
public sealed class RedisBackgroundRemovalJobQueue : IBackgroundRemovalJobQueue
{
    public const string DefaultQueueName = "outfit-planner:background-removal-jobs";

    private readonly IDatabase _database;
    private readonly RedisKey _queueName;
    private readonly TimeSpan _pollInterval;

    public RedisBackgroundRemovalJobQueue(IConnectionMultiplexer connection, string queueName = DefaultQueueName, TimeSpan? pollInterval = null)
    {
