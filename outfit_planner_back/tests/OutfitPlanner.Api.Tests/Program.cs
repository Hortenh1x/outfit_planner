...
static void TestUserRolesDefaultToFreeAndPinnedEmailsOverride()
{
    ...
    var premium = auth.RegisterWithPassword("premium.pinned@example.test", "abc12345", "abc12345");
...
static void TestAdminServiceChangesRolesWithGuards()
{
    ...
    var pinnedPremium = auth.RegisterWithPassword("premium.pinned@example.test", "abc12345", "abc12345");
...
static void TestCreditLedgerGrantsDebitsAndRefunds()
{
    ...
    var premiumUser = store.GetUserById(auth.RegisterWithPassword("premium.pinned@example.test", "abc12345", "abc12345").User.Id)
...
static void TestBillingServiceGatesCheckoutAndPortal()
{
    ...
    var free = store.GetUserById(auth.RegisterWithPassword("billing-free@example.com", "abc12345", "abc12345").User.Id)
        ?? throw new InvalidOperationException("Free account was not stored.");
    var premium = store.GetUserById(auth.RegisterWithPassword("premium.pinned@example.test", "abc12345", "abc12345").User.Id)
        ?? throw new InvalidOperationException("Premium account was not stored.");
...
static void TestBillingWebhooksDriveRolesAndTopUps()
{
    ...
    var pinnedPremium = store.GetUserById(auth.RegisterWithPassword("premium.pinned@example.test", "abc12345", "abc12345").User.Id)
